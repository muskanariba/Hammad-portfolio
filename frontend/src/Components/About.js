    ...
    <section id="about" className="bg-gray-100 py-20 px-6 md:px-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-12 gap-8 items-start relative">
          ...
          {/* Left Card */}
          <div className="col-span-12 md:col-span-7 relative flex justify-center">
            <div
              className="absolute bg-[#162c6b] rounded-2xl"
              style={{
                top: '20px',
                left: '-25px',
                width: '108%',
            ...
            <motion.div
              ...
              className="relative bg-white rounded-2xl shadow-xl p-8 md:p-12 text-base md:text-lg leading-snug font-sans tracking-wide
                         transition-all duration-500 ease-in-out hover:scale-[1.05] hover:rotate-[1deg] hover:shadow-[0_10px_30px_rgba(22,44,107,0.4)] h-[350px] overflow-hidden"
              style={{
                borderLeft: '12px solid #162c6b',
                borderTop: '12px solid #162c6b',
                borderBottom: '12px solid #162c6b',
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 1 }}
            className="col-span-12 md:col-span-5 relative ml-6"
          >
            {/* Connecting Lines */}
            ...
            <div className="grid grid-cols-2 gap-10 relative z-10">
              {[
                ...
                <motion.div
                  ...
                  className="flex flex-col items-center bg-white shadow-lg rounded-2xl p-8 transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-[0_8px_25px_rgba(22,44,107,0.3)] group relative"
                >
                  <div className="transform transition-transform duration-300 group-hover:scale-125 text-[#162c6b]">
                    {React.cloneElement(item.icon, { className: "w-[50px] h-[50px]" })}
                  </div>
                  <p className="mt-6 font-medium text-black text-center">{item.text}</p>

                  {/* Connectors */}
                  {i === 0 && (
                    <>
                      <div className="absolute top-1/2 right-[-25px] w-[25px] h-[3px] bg-[#162c6b]"></div>
                      <div className="absolute bottom-[-25px] left-1/2 w-[3px] h-[25px] bg-[#162c6b]"></div>
                    </>
                  )}
                  {i === 1 && (
                    <div className="absolute bottom-[-25px] left-1/2 w-[3px] h-[25px] bg-[#162c6b]"></div>
